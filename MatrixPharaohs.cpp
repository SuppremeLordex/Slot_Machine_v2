...
MatrixPharaohs::MatrixPharaohs(std::vector<std::vector<int>> matrixVec) {
	_matrixVec = matrixVec;
}

std::vector<std::vector<int>> MatrixPharaohs::RandomNumbersInMatrixPharaohs(std::vector<std::vector<int>>& matrixVec) {
	srand(time(0));
	int randomNumber;
	int const numberOfFigures = 6;
...
std::vector<std::vector<int>> MatrixPharaohs::getVectorMatrixPharaos() {
	return _matrixVec;
}
void MatrixPharaohs::outPutMatrixPharaohs(std::vector<std::vector<int>>& matrixVec) {
